...
export const PLACE_CATEGORIES = [
  { key: "home", labelKey: "Place_cat_home", icon: House, color: "#2563EB" },
  {
    key: "work",
    labelKey: "Place_cat_work",
    icon: BriefcaseBusiness,
    color: "#F59E0B",
  },
  {
    key: "school",
    labelKey: "Place_cat_school",
    icon: GraduationCap,
    color: "#8B5CF6",
  },
  { key: "gym", labelKey: "Place_cat_gym", icon: Dumbbell, color: "#EF4444" },
  {
    key: "other",
...
export const PLACE_SUB_CATEGORIES = [
  { key: "cafe", labelKey: "Place_cat_cafe", icon: Coffee, color: "#92400E" },
  {
    key: "restaurant",
    labelKey: "Place_cat_restaurant",
    icon: Utensils,
    color: "#B45309",
  },
  { key: "bar", labelKey: "Place_cat_bar", icon: Beer, color: "#C2410C" },
  {
    key: "shop",
    labelKey: "Place_cat_shop",
    icon: ShoppingBag,
    color: "#0F766E",
  },
  {
    key: "health",
    labelKey: "Place_cat_health",
    icon: HeartPulse,
    color: "#BE123C",
  },
  {
    key: "nature",
    labelKey: "Place_cat_nature",
    icon: TreePine,
    color: "#15803D",
  },
] as const;
